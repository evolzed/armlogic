...
def work_thread(cam=0, pData=0, nDataSize=0):
    ...
    while True:
        ...
        #     f.write(str(pData))
        # data = cam.MV_CC_SaveImageEx2(data_buf)
        # print(data)
        print(data_buf)
        ...
        # print(dir(ret))
        # data = ret.to_bytes(3, byteorder="big")
        # print(data)

        image = Image.frombytes("RGB", (stFrameInfo.nWidth, stFrameInfo.nHeight), data_buf)
...
if __name__ == "__main__":
    ...
    # print(c_ubyte, nPayloadSize, data_buf)
    # TODO 获取照片
    # print(stParam)
    # ret = cam.MV_CC_SaveImageEx2(data_buf)
    # print(ret)
    try:
