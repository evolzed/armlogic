            ...
            do
            {
                ...
                while (nCount++ != 100)
                {
                    ...
                    if (MyCamera.MV_OK == nRet)
                    {
                        ...
                        Console.WriteLine("Get One Frame:" + "Chunk_ExposureTime[" + Convert.ToString(FrameInfo.fExposureTime) + "] , Chunk_SecondCount[" + Convert.ToString(FrameInfo.nSecondCount)
                                        + "] , Chunk_CycleCount[" + Convert.ToString(FrameInfo.nCycleCount) + "], Chunk_CycleOffset[" + Convert.ToString(FrameInfo.nCycleOffset)
