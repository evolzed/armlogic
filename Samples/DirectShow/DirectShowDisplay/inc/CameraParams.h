...
typedef struct _MV_SAVE_IMAGE_PARAM_T_EX_
{
    ...
    // [IN]     ch:Bayer格式转为RGB24的插值方法  0-最近邻 1-双线性 2-Hamilton
...
typedef enum _MV_GIGE_TRANSMISSION_TYPE_
{
    ...
    MV_GIGE_TRANSTYPE_UNICAST_WITHOUT_RECV   = 0x00010000 | MV_GIGE_TRANSTYPE_UNICAST,
    MV_GIGE_TRANSTYPE_MULTICAST_WITHOUT_RECV = 0x00010000| MV_GIGE_TRANSTYPE_MULTICAST,
...
typedef struct _MV_CC_TRANSMISSION_TYPE_T
{
