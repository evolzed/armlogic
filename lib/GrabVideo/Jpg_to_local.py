...
def connect_cam(nConnectionNum):
    """
...
def main():
    """主程序"""
    nConnectionNum = get_device_num()
    _cam, _data_buf, _nPayloadSize = connect_cam(nConnectionNum)
    ...
    #         break
    try:
        hThreadHandle = threading.Thread(target=work_thread, args=(_cam, _data_buf, _nPayloadSize))
        hThreadHandle.start()
    except:
...
if __name__ == "__main__":
    main()
>>>>>>> 6776d93c73ccacc2ef17f0b32db7ecfc8278b13a
